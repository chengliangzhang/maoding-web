-- -- 交付历史表
DROP PROCEDURE IF EXISTS `update_md_list_deliver`;
CREATE PROCEDURE `update_md_list_deliver`()
  BEGIN
    CREATE TABLE `md_list_deliver` (
  ...
  END;
call update_md_list_deliver();
DROP PROCEDURE IF EXISTS `update_md_list_deliver`;

-- -- 项目自定义属性（模板属性）
DROP PROCEDURE IF EXISTS `update_maoding_web_project_property`;
CREATE PROCEDURE `update_maoding_web_project_property`()
  BEGIN
  ...
  END;
call update_maoding_web_project_property();
DROP PROCEDURE IF EXISTS `update_maoding_web_project_property`;

-- -- 任务定义
DROP PROCEDURE IF EXISTS `update_maoding_web_project_task`;
CREATE PROCEDURE `update_maoding_web_project_task`()
  BEGIN
  ...
  END;
call update_maoding_web_project_task();
DROP PROCEDURE IF EXISTS `update_maoding_web_project_task`;

-- -- 常量定义
DROP PROCEDURE IF EXISTS `update_md_list_const`;
CREATE PROCEDURE `update_md_list_const`()
  BEGIN
  ...
  END;
call update_md_list_const();
DROP PROCEDURE IF EXISTS `update_md_list_const`;

-- -- 自定义常量定义
DROP PROCEDURE IF EXISTS `update_md_list_const_custom`;
CREATE PROCEDURE `update_md_list_const_custom`()
  BEGIN
  ...
  END;
call update_md_list_const_custom();
DROP PROCEDURE IF EXISTS `update_md_list_const_custom`;

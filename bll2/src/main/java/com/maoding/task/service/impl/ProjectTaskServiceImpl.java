...
//        }
    ...
    //获取生产任务所属的签发任务
    private List<ProjectTaskEntity> listIssueParentByTaskId(ProjectTaskEntity task){
        return projectTaskDao.listIssueParentByTaskId(task.getId());
    }
...
//            //是否是我参与的任务
    ...
    public DesignManagerDTO getDesignManagerInfo(QueryProjectTaskDTO query) throws Exception {
        ...
        //获取任务所属组织编号，在getSelectOrg内会更改query.companyId
        info.setDataCompanyId(query.getCompanyId());

...
public class ChineseToEnglishUtil {
    ...
    public static void main(String[] args) {  
        ...
        System.out.println(getPingYin("綦發江qq县"));
        System.out.println(getPingYin("發財"));
        System.out.println(getPingYin("豐厚"));
        System.out.println(getPingYin("鳳凰"));
        System.out.println(getPingYin("凤凰"));
        System.out.println(getPingYin("凤凰"));

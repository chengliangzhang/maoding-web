    ...
    Map<String,String> messageForApp2=new HashMap<String,String>(){
        {
            ...
            put("3","%sendUserName% 变更了“%projectName%”的经营负责人，请你担任该项目的经营负责人，点击查看详情。" );
            //hi,XXX增加了“卯丁科技大厦一期”的设计任务，请在任务中查看并进行［任务签发］，
            put(String.format("%d", MESSAGE_TYPE_301),"%sendUserName% 创建了%projectName%的项目，请你担任该项目的经营负责人，点击查看详情。" );
            /*******合作组织消息********2017-12-27 修改两条信息相同*/
            //hi,xxx组织，经营负责人XXX发布了“卯丁科技大厦一期”的设计任务，请你担任该项目的经营负责人，请在任务中查看并进行［任务签发］，
            put(String.format("%d", MESSAGE_TYPE_302),"hi,%sendCompanyName%组织，%sendUserName% 增加了“%projectName%”的设计任务，点击查看详情。" );
            //hi,xxx组织，经营负责人XXX发布了“卯丁科技大厦一期”的设计任务，请在任务中查看并进行［任务签发］，
            put(String.format("%d", MESSAGE_TYPE_303),"hi,%sendCompanyName%组织，经营负责人%sendUserName%发布了“%projectName%”的设计任务，请你担任该项目的经营负责人,点击查看详情。" );
            put(String.format("%d", MESSAGE_TYPE_306), "hi,%sendCompanyName%组织，%sendUserName% 发布了“%projectName%”的设计任务，点击查看详情。");//ok

            /****************/
            //“卯丁科技大厦一期-方案设计”的设计任务已完成，请你跟进相关项目收支的经营工作，
            put(String.format("%d", MESSAGE_TYPE_304),"“%projectName%-%taskName%”的设计任务已完成，请你跟进相关项目收支的经营工作。" );

            put(String.format("%d", MESSAGE_TYPE_305),"%sendUserName% 指定了你为 “%projectName%”的经营助理，点击查看详情。" );

            put("4","你成为了 “%projectName%” 设计负责人" );//ok
            /******************** 任务负责人************************/
            // hi,经营负责人XXX发布了“卯丁科技大厦一期”的设计任务，请你担任该项目的设计负责人，请在任务中查看并进行［生产安排］，（第一次发布任务给本组织）
            put(String.format("%d", MESSAGE_TYPE_401),"%sendUserName% 发布了“%projectName%”的设计任务，请你担任该项目的设计负责人，点击查看详情。" );
            // hi,经营负责人XXX发布了“卯丁科技大厦一期”的设计任务，请在任务中查看并进行［生产安排］，（第二次及后面发布任务给本组织）
            put(String.format("%d", MESSAGE_TYPE_402),"%sendUserName% 发布了“%projectName%”的设计任务，点击查看详情。" );
            //设计负责人XXX进行了“卯丁科技大厦一期-建筑设计”的生产安排，你被设定为任务负责人，详情点击［我的任务］查看，
            put(String.format("%d", MESSAGE_TYPE_403),"%sendUserName% 指定了你为“%projectName%-%taskName%”的任务负责人，点击查看详情。" );
            //任务负责人XXX进行了“卯丁科技大厦一期-建筑设计”的生产安排，你被设定为任务负责人，详情点击［我的任务］查看，
            put(String.format("%d", MESSAGE_TYPE_404),"%sendUserName% 指定了你为“%projectName%-%taskName%”的任务负责人，点击查看详情。" );
            //“卯丁科技大厦一期-方案设计”的设计/校对/审核任务已完成，请你确认，
            put(String.format("%d", MESSAGE_TYPE_405),"“%projectName%-%taskName%”的%nodeName%任务已完成，请你确认，" );
            ...
            put(String.format("%d", MESSAGE_TYPE_407),"%sendUserName%  提交了 “%projectName%-%taskName%”的设计任务已完成，现“%projectName%”整体工作已提交请你确认工作。" );
            //本团队所有的生产任务已经完成（包含签发给其他组织的任务）：“卯丁科技大厦一期-方案设计，初步设计....”所有生产任务已完成，请你确认，
            //许佳迪，提交了“卯丁科技大厦一期-方案设计”的设计任务，现“卯丁科技大厦一期”整体工作已提交请你确认工作。
            put(String.format("%d", MESSAGE_TYPE_408),"%sendUserName% 提交了“%projectName%-%taskName%”的设计任务，现“%projectName%”整体工作已提交请你确认工作。" );//此处还应该推送任务，任务类型22
            //合作方 A 给 B的任务全部完成，给A组织的设计负责人推送消息
            put(String.format("%d", MESSAGE_TYPE_409),"%sendUserName%  提交了“%projectName%-%taskName%”的设计任务已完成，请你跟进相关项目收支的经营工作。" );
            put(String.format("%d", MESSAGE_TYPE_410),"%sendUserName% 指定了你为 “%projectName%”的设计助理，点击查看详情");
            ...
            put(String.format("%d", MESSAGE_TYPE_501),"%sendUserName% 指定了你为“%projectName%-%taskName%”的%nodeName%人员，点击查看详情。" );//ok
            put(String.format("%d", MESSAGE_TYPE_502),"%sendUserName% 指定了你为“%projectName%-%taskName%”的%nodeName%人员，点击查看详情。" );//ok
            //XXX完成了“卯丁科技大厦一期-方案设计”的设计工作，请你校对，
            //XXX完成了“卯丁科技大厦一期-方案设计”的校对工作，请你审核，
            put(String.format("%d", MESSAGE_TYPE_503),"%sendUserName% 完成了“%projectName%-%taskName%”的%nodeName%工作，请你%toNodeName%。" );//ok
            ...
            put("21","“%projectName%-%taskName%”所有子任务已全部完成");//ok
            /**************报销***************/
            put("19","%sendUserName%申请报销“%expName%”共计%expAmount%元，请你审批。");//ok
            //?共计?元的报销申请不予批准---XXX拒绝了你申请的“办公用品”报销金额200.00元
            put("20","%sendUserName%拒绝了你申请的“%expName%”报销金额%expAmount%元，退回原因：%reason%。");//ok
            //你申请“?”共计?元已审批通过 -- XXX同意你“办公用品”的报销金额为2000元，
            put("22","%sendUserName%同意你“%expName%”的报销金额为%expAmount%元。");
            //XXX转交了许佳迪申请的“办公用品”报销金额200.00元，请你审批，
            put("221","%sendUserName%同意并转交了%expUserName%的报销申请“%expName%”，共计%expAmount%元给你，请你审批。");
            /***********费用部分***********/
            put("222","%sendUserName%申请费用“%expName%”共计%expAmount%元，请你审批。");//ok
            //?共计?元的报销申请不予批准---XXX拒绝了你申请的“办公用品”报销金额200.00元
            put("223","%sendUserName%拒绝了你申请的“%expName%”费用金额%expAmount%元，退回原因：%reason%。");//ok
            //你申请“?”共计?元已审批通过 -- XXX同意你“办公用品”的报销金额为2000元，
            put("224","%sendUserName%同意你“%expName%”的费用金额为%expAmount%元。");//报销单审批完成后发给报销人送消息
            //毛双凤同意并转交了郭志彬的费用申请“差旅费用”共计1200元，给您，请您审批。
            put("225","%sendUserName%同意并转交了%expUserName%的费用申请“%expName%”，共计%expAmount%元给你，请你审批。");
            /***********请假部分***********/
            put("226","%sendUserName% 提交了请假申请，请假类型：%leaveTypeName%，请假时间：%startTime1% - %endTime1%，请您审批。");//ok
            put("227","%sendUserName% 拒绝了你的请假申请，请假类型“%leaveTypeName%”，请假时间：%startTime1% - %endTime1%，退回原因：%reason%。");//ok
            //您提交的请假申请，请假类型：事假，请假时间：2017/12/26 09:00-2017/12/27 18:00，已完成审批。
            ...
            put("11","%sendUserName%发起了“%projectName%：%feeDescription%”的技术审查费%fee%万元，请确认付款金额。");
            //
            put("12","“%projectName% - 技术审查费 - %feeDescription%” 金额：%fee%万，已确认付款"); //
            put("13","“%projectName% - 技术审查费 - %feeDescription%” 金额：%fee%万，已确认到账");

            //合作设计费
            //? - 合作设计费 - ?” 金额：?万，需要你确认付款 -->XXX发起了“卯丁科技大厦一期：合作设计费节点”的合作设计费30万元，请确认付款金额，
            put("14","%sendUserName%发起了“%projectName%：%feeDescription%”的合作设计费%fee%万元，请确认付款金额。");

            put("15","“%projectName% - 合作设计费 - %feeDescription%” 金额：%fee%万，已确认付款");
            put("16","“%projectName% - 合作设计费 - %feeDescription%” 金额：%fee%万，已确认到账");
            ...
            put("23","，%sendUserName%确认了“%projectName%：%feeDescription%”的技术审查费付款金额为%fee%万元，请你跟进并确认实际付款日期，");//技术审查费财务人员付款操作
            ...
            put("25","%sendUserName%确认了“%projectName%：%feeDescription%”的合作设计费付款金额为%fee%万元，请你跟进并确认实际付款日期。");//合作设计费财务人员付款操作
            //? - 合作设计费 - ?” 金额：?万，已到账，请进行相关操作-->XXX确认了“卯丁科技大厦一期：合作设计费节点”的合作设计费付款金额为30万元，请你跟进并确认实际到账日期，
            put("26","%sendUserName%确认了“%projectName%：%feeDescription%”的合作设计费付款金额为%fee%万元，请你跟进并确认实际到账日期。");//合作设计费财务人员到账操作

            //? - 技术审查费 - ?” 金额：?万，已确认付款，付款日期为?--->XXX确认了“卯丁科技大厦一期：技术审查费节点”的技术审查费付款金额为30万元，实际付款日期为xxxx-xx-xx，
            put("27","%sendUserName%确认了“%projectName%：%feeDescription%”的技术审查费付款金额为%fee%万元，实际付款日期为%paymentDate%。");//技术审查费付款，通知经营负责人，企业负责人
            ...
            put("29","%sendUserName%确认了“%projectName%：%feeDescription%”的合作设计费付款金额为%fee%万元，实际付款日期为%paymentDate%。");//合作设计费付款，通知经营负责人，企业负责人
            ...
            put(String.format("%d", MESSAGE_TYPE_PHASE_TASK_CHANGE),"立项人%sendUserName%通知您， %taskName%的时间进行了调整，由%startTime1%变更为%endTime1%"); //设计内容时间更改
            put(String.format("%d",MESSAGE_TYPE_ISSUE_TASK_CHANGE),"?经营负责人%sendUserName%通知您， %taskName%的计划进度进行了调整，由%startTime1%变更为%endTime1%"); //签发任务时间更改
            put(String.format("%d",MESSAGE_TYPE_PRODUCT_TASK_CHANGE),"任务负责人%sendUserName%通知您， %taskName%的计划进度进行了调整，由%startTime1%变更为%endTime1%"); //生产任务时间更改
            put(String.format("%d",MESSAGE_TYPE_PRODUCT_TASK_FINISH),"%sendUserName%， %taskName%已完成，您看是否需要现在去处理相关项目费用的事宜？"); //生产任务完成

            //权限改动
            //hi,你被设定为“圆正测试设计院”系统管理员，相应权限请点击［个人设置］查看。
            put(String.format("%d",MESSAGE_TYPE_NEW_SYSTEM_MANAGER),"%sendUserName% 设定你为“%sendCompanyName%”系统管理员，点击查看详情。"); //系统管理员移交，给新的管理员推送消息
            //系统管理员重新设置了你的权限，请点击［个人设置］查看。
            put(String.format("%d",MESSAGE_TYPE_ROLE_CHANGE),"%sendUserName% 修改了你的权限，请点击查看详情。"); //个人权限变动，推送消息
            //hi,你被设定为“圆正测试设计院”企业负责人，相应权限请点击［个人设置］查看。
            put(String.format("%d",MESSAGE_TYPE_NEW_ORG_MANAGER),"%sendUserName% 设定你为“%sendCompanyName%”企业负责人，点击查看详情。"); //企业负责人移交，给新的企业负责人推送消息

            //确定乙方:hi,“卯丁科技大厦一期”项目由“立项组织/XXX”完成立项，请你根据项目进度跟进相关工作，
            put(String.format("%d",MESSAGE_TYPE_PART_B),"%sendUserName% 创建了“%projectName%”项目由“立项组织/%sendCompanyName%”完成立项，请你根据项目进度跟进相关工作。"); //确定乙方
            //第一次发布任务给本团队，则给本团队的企业负责人推送消息
            put(String.format("%d",MESSAGE_TYPE_PUBLISH_TASK_ORG_MANAGER),"%sendUserName% 创建了“%projectName%”项目，该项目的经营负责人是：%projectManagerName%，设计负责人是：%designerName%，你可根据具体情况进行调整。");

            //会议，日程消息模板
            put(String.format("%d",MESSAGE_TYPE_701),"%sendUserName% 已为你安排日程，日程内容“%scheduleContent%”，日程时间：%startTime1% - %endTime1%，点击查看详情。");
            put(String.format("%d",MESSAGE_TYPE_702),"%sendUserName% 已修改安排日程，日程内容“%scheduleContent%”，日程时间：%startTime1% - %endTime1%，点击查看详情。");
            put(String.format("%d",MESSAGE_TYPE_703),"%sendUserName% 已取消安排日程，日程内容“%scheduleContent%”，日程时间：%startTime1% - %endTime1%，请知晓。");
            put(String.format("%d",MESSAGE_TYPE_704),"%sendUserName% 已为你安排会议，会议内容“%scheduleContent%”，会议时间：%startTime1% - %endTime1%， 如同意参加，点击详情回复是否参会。");
            put(String.format("%d",MESSAGE_TYPE_705),"%sendUserName% 已修改安排会议，会议内容“%scheduleContent%”，会议时间：%startTime1% - %endTime1%， 如同意参加，点击详情回复是否参会。");
            put(String.format("%d",MESSAGE_TYPE_706),"%sendUserName% 已取消安排会议，会议内容“%scheduleContent%”，会议时间：%startTime1% - %endTime1%，请知晓。");
            put(String.format("%d",MESSAGE_TYPE_707),"%sendUserName% 已确定参加会议“%scheduleContent%”，点击查看详情。");
            put(String.format("%d",MESSAGE_TYPE_708),"%sendUserName% 已确定不参加会议“%scheduleContent%”，不参加原因“%reason%”，点击查看详情。");
            put(String.format("%d",MESSAGE_TYPE_709), "你的日程“%scheduleContent%”即将开始，点击查看详情。");
    ...
    Map<String,MessageTemplate> messageForApp=new HashMap<String,MessageTemplate>(){
        {
            ...
            put(String.format("%d", MESSAGE_TYPE_DELIVER_CONFIRM),new MessageTemplate( "%sendUserName% 发起了 %deliverName% 交付任务，并将你设置为任务负责人，截止时间：%deadline%，请你确认。",1));
            put(String.format("%d", MESSAGE_TYPE_DELIVER_UPLOAD),new MessageTemplate( "%sendUserName% 发起了 %deliverName% 交付任务，任务负责人为 %responseName% ; 截止时间为：%deadline%，请您提交交付文件。",1));

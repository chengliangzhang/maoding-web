...
(function(root, factory) {
    ...
    var validate = {
        ...
        initialCheck: function(pie) {
            ...
            if (!window.d3v4 || !window.d3v4.hasOwnProperty("version")) {
    ...
    var helpers = {
        ...
        addSVGSpace: function(pie) {
            ...
            var svg = d3v4.select(element).append("svg:svg")
...
// taken from jQuery
    ...
    var labels = {
        ...
        positionLabelElements: function(pie, section, sectionDisplayType) {
            ...
            var labelGroups = d3v4.selectAll("." + pie.cssPrefix + "labelGroup-" + section);
            labelGroups.each(function(d, i) {
                var mainLabel  = d3v4.select(this).selectAll("." + pie.cssPrefix + "segmentMainLabel-" + section);
                var percentage = d3v4.select(this).selectAll("." + pie.cssPrefix + "segmentPercentage-" + section);
                var value      = d3v4.select(this).selectAll("." + pie.cssPrefix + "segmentValue-" + section);
            ...
            switch (sectionDisplayType) {
                case "label-value1":
                    d3v4.selectAll("." + pie.cssPrefix + "segmentValue-" + section)
                ...
                case "label-percentage1":
                    d3v4.selectAll("." + pie.cssPrefix + "segmentPercentage-" + section)
                        .attr("dx", function(d, i) { return dims[i].mainLabel.width + singleLinePad; });
                    break;
        ...
        computeLabelLinePositions: function(pie) {
            pie.lineCoordGroups = [];
            d3v4.selectAll("." + pie.cssPrefix + "labelGroup-outer")
        ...
        positionLabelGroups: function(pie, section) {
            ...
            d3v4.selectAll("." + pie.cssPrefix + "labelGroup-" + section)
                .style("opacity", 0)
        ...
        fadeInLabelsAndLines: function(pie) {
            ...
            setTimeout(function() {
                ...
                d3v4.selectAll("." + pie.cssPrefix + "labelGroup-inner")
                    .transition()
                    .duration(labelFadeInTime)
                    .style("opacity", function(d, i) {
                ...
                d3v4.selectAll("g." + pie.cssPrefix + "lineGroups")
                    .transition()
                    .duration(labelFadeInTime)
                    .style("opacity", 1);
        ...
        getIdealOuterLabelPositions: function(pie, i) {
            var labelGroupNode = d3v4.select("#" + pie.cssPrefix + "labelGroup" + i + "-outer").node();
            if (!labelGroupNode) {
                return;
            }
    ...
    var segments = {
        ...
        effectMap: {
            "none": d3v4.easeLinear,
            "bounce": d3v4.easeBounce,
            "linear": d3v4.easeLinear,
            "sin": d3v4.easeSin,
            "elastic": d3v4.easeElastic,
            "back": d3v4.easeBack,
            "quad": d3v4.easeQuad,
            "circle": d3v4.easeCircle,
            "exp": d3v4.easeExp
        },
        ...
        create: function(pie) {
            ...
            g.append("path")
                ...
                .transition()
                .ease(d3v4.easeCubicInOut)
                .duration(loadSpeed)
                .attr("data-index", function(d, i) { return i; })
                .attrTween("d", function(b) {
                    var i = d3v4.interpolate({ value: 0 }, b);
                    return function(t) {
                        return pie.arc(i(t));
                    };
                });
        ...
        addSegmentEventHandlers: function(pie) {
            var arc = d3v4.selectAll("." + pie.cssPrefix + "arc,." + pie.cssPrefix + "labelGroup-inner,." + pie.cssPrefix + "labelGroup-outer");

            arc.on("click", function() {
                var currentEl = d3v4.select(this);
                var segment;
                ...
                if (currentEl.attr("class") === pie.cssPrefix + "arc") {
                    ...
                    segment = d3v4.select("#" + pie.cssPrefix + "segment" + index);
                }
        ...
        openSegment: function(pie, segment) {
            ...
            d3v4.select(segment).transition()
                ...
                .on("end", function(d, i) {
                    ...
                    d3v4.select(segment).attr("class", pie.cssPrefix + "expanded");
                });
        },

        maybeCloseOpenSegment: function() {
            if (d3v4.selectAll("." + pie.cssPrefix + "expanded").size() > 0) {
                segments.closeSegment(pie, d3v4.select("." + pie.cssPrefix + "expanded").node());
            }
        },
        ...
        closeSegment: function(pie, segment) {
            d3v4.select(segment).transition()
                ...
                .on("end", function(d, i) {
                    d3v4.select(segment).attr("class", "");
    ...
    var tt = {
        ...
        showTooltip: function(pie, index) {
            ...
            d3v4.select("#" + pie.cssPrefix + "tooltip" + index)
                .transition()
        ...
        moveTooltip: function(pie) {
            d3v4.selectAll("#" + pie.cssPrefix + "tooltip" + tt.currentTooltip)
                .attr("transform", function(d) {
                    var mouseCoords = d3v4.mouse(this.parentNode);
        ...
        hideTooltip: function(pie, index) {
            ...
            d3v4.select("#" + pie.cssPrefix + "tooltip" + tt.currentTooltip)
                .attr("transform", function(d, i) {
    ...
    var d3pie = function(element, options) {
        ...
        d3v4.select(this.element).attr(_scriptName, _version);
    ...
    d3pie.prototype.destroy = function() {
        ...
        d3v4.select(this.element).attr(_scriptName, null); // remove the data attr
    };
    ...
    d3pie.prototype.getOpenSegment = function() {
        ...
        if (segment !== null && typeof segment !== "undefined") {
            var index = parseInt(d3v4.select(segment).attr("data-index"), 10);
            return {
                element: segment,
                index: index,
    ...
    d3pie.prototype.openSegment = function(index) {
        ...
        segments.openSegment(this, d3v4.select("#" + this.cssPrefix + "segment" + index).node());
    };
    ...
    d3pie.prototype.updateProp = function(propKey, value) {
        switch (propKey) {
            case "header.title.text":
                ...
                d3v4.select("#" + this.cssPrefix + "title").html(value);
            ...
            case "header.subtitle.text":
                ...
                helpers.processObj(this.options, propKey, value);
                d3v4.select("#" + this.cssPrefix + "subtitle").html(value);

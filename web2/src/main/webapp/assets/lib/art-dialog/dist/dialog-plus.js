...
!(function() {
    ...
    function(require) {
        ...
        artDialog.create = function(options) {
            ...
            if (options.quickClose) {
                $backdrop.on('onmousedown' in document ? 'mousedown': 'click',
                function() {
                    that._trigger('cancel');
                    return false
                })
            ...
            button: function(args) {
                ...
                if (typeof args === 'string') {
                    ...
                    function(i, val) {
                        ...
                        that._$('button').on('click', '[i-id=' + id + ']',
                        function(event) {
                            var $this = $(this);
    ...
    function(require) {
        ...
        dialog.oncreate = function(api) {
            ...
            if (url) {
                ...
                api.addEventListener('beforeremove',
                function() {
            ...
            $(api.node).on(drag.types.start, '[i=title]',
            function(event) {
                if (!api.follow) {
                    api.focus();

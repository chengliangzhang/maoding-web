...
(function () {
    ...
    function U(K, C) {
        ...
        function D() {
            if (G) {
                func = D.caller;
                while (func != null) {
                    //此处添加try catch解决safari浏览器报type error的问题
                    try {
    ...
    function I(G, _) {
        ...
        function E(K, J) {
            var I = V[N].domain,
                F = false,
                G = "<iframe hideFocus=true width=9 height=7 frameborder=0 border=0 scrolling=no src=\"about:blank\" style=\"box-shadow: 0 0 10px rgba(0,0,0,.3);width:241px;\"></iframe>";
            K.innerHTML = G;
            var _ = $.$langList,
                D = $.$skinList,
                H;
            ...
            function C() {
                ...
                for (var C = 0; C < D.length; C++) if (D[C].name == J.skin) $.push("<link rel=\"stylesheet\" type=\"text/css\" href=\"" + A + "skin/" + D[C].name + "/datepicker.min.css\" charset=\"" + D[C].charset + "\"/>");
                $.push("<script src=\"" + A + "calendar.js\"></script>");

                //自定义修改--开始
                var rootPath = window.rootPath;
                if (rootPath != undefined && rootPath != '') {
                    $.push("<link rel=\"stylesheet\" type=\"text/css\" href=\"" + rootPath + "/assets/css/help.css\">");
                    $.push("<link rel=\"stylesheet\" type=\"text/css\" href=\"" + rootPath + "/assets/lib/font-awesome/css/font-awesome.min.css\">");
                } else {
                    $.push("<link rel=\"stylesheet\" type=\"text/css\" href=\"/assets/css/help.css\">");
                    $.push("<link rel=\"stylesheet\" type=\"text/css\" href=\"/assets/lib/font-awesome/css/font-awesome.min.css\">");
                }
                //自定义修改--结束

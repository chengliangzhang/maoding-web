...
contextMenu.prototype.init = function () {
    ...
    this.addClass(this.menuBox, "contextMenuBox");
    this.addClass(this.menuBox, this.opt.menuClass);

    if (this.opt.hasTitle) {
        this.menuTitle = document.createElement('h2');
        this.addClass(this.menuTitle, "contextMenuTitle");
        ...
        if (this.opt.menu.title.icon && this.opt.menu.title.icon.length != 0) {
            ...
            this.addClass(titleIcon, "contextMenuTitleIcon");
            if (!this.opt.linkClass) {
        ...
        this.addClass(titleCon, "contextMenuTitleCon");
        if (!this.opt.linkClass) {
    ...
    if (items) {
        for (i = 0; i < items.length; i++) {
            ...
            if (items[i] === "-") {
                ...
                this.addClass(item, "contextMenuSeparator");
                if (!this.opt.linkClass) {
                ...
                item = document.createElement("div");
                this.addClass(item, "contextMenuItem");


                if (items[i].icon && items[i].icon.length != 0) {
                    var image = this.opt.hasIcon ? "img" : "span";
                    var icon = document.createElement(image);
                    this.addClass(icon, "contextMenuItemIcon");
                    if (!this.opt.linkClass) {
                ...
                this.addClass(con, "contextMenuItemCon");
                if (!this.opt.linkClass) {
                ...
                if (items[i].keymap) {
                    ...
                    this.addClass(keymap, "contextMenuKeyMap");
    ...
    this.$("body")[0].appendChild(this.menuBox);
    this.hide();
    this.bind();
};

...
<script type="text/javascript" src="<%=rootPath %>/assets/lib/html5shiv.min.js"></script>
<script type="text/javascript" src="<%=rootPath %>/assets/lib/placeholder-IE-fixes.min.js"></script>
<![endif]-->
...
<!-- 百度统计 -->
<script type="text/javascript" src="<%=rootPath %>/assets/js/baidutotal.js?v=<%=v%>"></script>

<script type="text/javascript" src="<%=rootPath %>/assets/js/module.js?v=<%=v%>"></script>
<script type="text/javascript" src="<%=rootPath %>/assets/js/messageCenter.js?v=<%=v%>"></script>
